...
function buildHeaders() {
    // НЕ добавляйте случайные query параметры!
    const rand_path = parsedTarget.pathname || "/";
    ...
    const headers = {
        ...
        "sec-fetch-site": "none",  // ФИКСИРОВАННОЕ значение для прямой навигации
        "sec-fetch-user": "?1"     // ОБЯЗАТЕЛЬНО для navigate
    };
